...
const procurementLabel = (state) => ({required:"Нужно закупить",in_progress:"Закупка оформлена",received:"Получено",not_required:"Не требуется",cancelled:"Закупка отменена"}[state] || state || "—");
