...
def _get_or_create_health(session: Session, supplier_id: int) -> SourceHealth:
...
def apply_source_success(
    ...
    *,
    ...
    health = _get_or_create_health(session, supplier_id)
...
def apply_source_failure(
    ...
    *,
    ...
    signals open a bounded source-level breaker immediately. Ordinary failures
    degrade the source after three consecutive failed observations.
    """
