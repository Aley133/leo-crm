...
class MarketplaceListingEventType(StrEnum):
    RESOLVED = "resolved"
...
class MarketplaceListingEvent(Base):
    ...
    previous_product_id: Mapped[int | None] = mapped_column(Integer, nullable=True)
    current_product_id: Mapped[int | None] = mapped_column(Integer, nullable=True)
