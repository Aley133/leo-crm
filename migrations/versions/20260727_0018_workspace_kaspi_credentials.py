...
def upgrade() -> None:
    ...
    op.create_index("ix_kaspi_account_credentials_marketplace_account_id", "kaspi_account_credentials", ["marketplace_account_id"])
    op.create_index("ix_kaspi_account_credentials_workspace_id", "kaspi_account_credentials", ["workspace_id"])


def downgrade() -> None:
    op.drop_index("ix_kaspi_account_credentials_workspace_id", table_name="kaspi_account_credentials")
    op.drop_index("ix_kaspi_account_credentials_marketplace_account_id", table_name="kaspi_account_credentials")
